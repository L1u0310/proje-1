            ...
            <div class="row">
                <div class="col-md-2 bg-dark" style="min-height:96vh;">
                    <ul class="list-group">
                        ...
                        <a href="hizmet-paketleri.php">
                            <li class="list-group-item">hizmet paketleri</li>
                        </a>
                        <a href="reklam.php">
                        ...
                        <a href="seo-talep.php">
                            <li class="list-group-item">Seo Talepleri</li>
                        </a>
                        <a href="kategori.php">
                        ...
                        <a href="main-page.php">
                            <li class="list-group-item">Ana Sayfa Ayarları</li>
                        </a>
